...
public class screen6 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Generate.setOnClickListener(v ->
        {
            ...
            {
                Toast.makeText(screen6.this, "Enter two numbers!!", Toast.LENGTH_SHORT).show();
            }
            else if(TextUtils.isEmpty(number1.getText().toString()))
            {
                Toast.makeText(screen6.this, "Enter first number!!", Toast.LENGTH_SHORT).show();
            }
            else if(TextUtils.isEmpty(number2.getText().toString()))
            {
                Toast.makeText(screen6.this, "Enter second number!!", Toast.LENGTH_SHORT).show();
